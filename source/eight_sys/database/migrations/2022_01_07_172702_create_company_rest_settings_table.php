...
class CreateCompanyRestSettingsTable extends Migration
{
    /**
     * 
     * 企業ごとの休日に関する規定設定
    ...
    public function up()
    {
        Schema::create('company_rest_settings', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('company_rest_settings');
    }
}
